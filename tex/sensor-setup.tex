...
These parameters were estimated using Allan variance method. For calibration, 11 hours of stationary IMU data were recorded. We chose allan\_variance\_ros toolbox for calibration. In short, Allan variance 
